...
/*
    ...
    */
    ...
    /*
    public static TreeSet<SubArtigo.Artigo> loadArtigos() throws IOException, ClassNotFoundException {
        new File("artigos.bin");
        TreeSet<SubArtigo.Artigo> artigos = null;
    ...
    public static List<SubArtigo.Artigo> loadArtigos_STATIC() {

        SubEncomenda.Transportadora fedex = new SubEncomenda.Transportadora("FedEx", 0.4, 0.55);
        SubEncomenda.Transportadora ctt = new SubEncomenda.Transportadora("CTT", 0.5, 0.45);
        SubEncomenda.Transportadora  chronopost = new SubEncomenda.Transportadora(" Chronopost", 0.3, 0.8);

        // Sapatilhas
        SubArtigo.Artigo a1 = new SubArtigo.Sapatilha("novo", "Sapatilhas muito bonitas", "Rebook", 32.45, 0.3, 0, fedex, 43, "atacadores", "vermelho", "2023-02-27");
        SubArtigo.Artigo a2 = new SubArtigo.Sapatilha("novo", "Sapatilhas ainda mais bonitas", "Adidas", 44.50, 0.2, 0, ctt, 40, "atilhos", "verde", "2023-01-01");
        SubArtigo.Artigo a3 = new SubArtigo.Sapatilha("usado", "Sapatilhas um bocado usadas mais ainda boas", "Geox", 10, 0.1, 1, chronopost, 38, "atacadores", "branco", "2022-11-10");
        SubArtigo.Artigo a4 = new SubArtigo.Sapatilha("usado", "Sapatilhas usadas em bom estado", "Nike", 15, 0.15, 1, fedex, 41, "atacadores", "branco", "2018-09-12");
        SubArtigo.Artigo a5 = new SubArtigo.Sapatilha("novo", "Sapatilhas New Balance coleção 2023", "New Balance", 46.80, 0.2, 0, ctt, 42, "atacadores", "azul", "2023-03-10");
        SubArtigo.Artigo a6 = new SubArtigo.Sapatilha("novo", "Sapatilhas de boa marca", "Adidas", 35.60, 0.2, 0, chronopost, 46, "atilhos", "roxo", "2023-04-01");
        SubArtigo.Artigo a7 = new SubArtigo.Sapatilha("usado", "Sapatos em bom estado", "Calvin Klein", 45, 0.35, 1, ctt, 41, "atilhos", "bege", "2020-08-12");
        SubArtigo.Artigo a8 = new SubArtigo.Sapatilha("usado", "Botas usadas de qualidade", "Timberland", 21, 0.2, 2, fedex, 42, "atacadores", "castanho", "2019-11-12");
        SubArtigo.Artigo a9 = new SubArtigo.Sapatilha("usado", "Sapatilhas de corrida em bom estado", "Puma", 25, 0.22, 1, chronopost, 39, "atacadores", "amarelo", "2021-05-04");
        SubArtigo.Artigo a10 = new SubArtigo.Sapatilha("novo", "Sapatilhas novas da Nike", "Nike", 48, 0.19, 0, ctt, 40, "atacadores", "vermelho", "2023-05-04");
        SubArtigo.Artigo a11 = new SubArtigo.Sapatilha("usado", "Sapatos usados Michael Kors", "Michael Kors", 40, 0.23, 1, fedex, 38, "atacadores", "preto", "2020-04-23");
        SubArtigo.Artigo a12 = new SubArtigo.Sapatilha("usado", "Botas de senhora usados", "Calvin Klein", 37, 0.11, 1, chronopost, 39, "atilhos", "preto", "2022-06-13");
        SubArtigo.Artigo a13 = new SubArtigo.Sapatilha("novo", "Sapatilhas novas para menina", "Geox", 50, 0.2, 0, fedex, 31, "atacadores", "rosa", "2023-03-10");
        ...
        TreeSet<SubUtilizador.Utilizador> users = new TreeSet();
    ...
    public static Campeonato loadSavedGame(String filename) throws FileNotFoundException, IOException, ClassNotFoundException {
        ...
        ArrayList<SubUtilizador.Utilizador> jogad = (ArrayList)game.readObject();
        HashSet<SubUtilizador.Utilizador> apostCamp = (HashSet)game.readObject();
    ...
    public static void saveGame(String filename, int nCamp, ArrayList<Circuito> circs, int nCorr, TreeSet<Carro> parts, Classificacao classif, ArrayList<SubUtilizador.Utilizador> jogad, HashSet<SubUtilizador.Utilizador> apostCamp) throws IOException {
    ...
    public static void saveUtilizadores(Utilizadores bdjogadores, ArrayList<SubUtilizador.Utilizador> cUsers) throws IOException {
        Iterator var2 = cUsers.iterator();

        while(var2.hasNext()) {
            SubUtilizador.Utilizador utilizador = (SubUtilizador.Utilizador)var2.next();
